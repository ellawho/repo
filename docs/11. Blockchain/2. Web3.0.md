...
This web3.0 project was super exciting.  It was amazing to follow a Youtube tutorial and learnt the fundamental of a React application that interacts with Blockchain.   

In My previous job, we had talked a lot about Decentralised Finance on Blockchain and my understanding at the time was on a very high level of overview.  
...
* **Web3.0:** the next generation of web application that allows you to Read, Write and Own, interact decentralised system.   
...
* **Wallets:** Hosted, Self-custody, Hardware, MetaMask is self-hosted wallet, CoinBase is hosted wallet 
* **Gas fee:** function as transaction fee that pay towards the miners 
* **Solidity:** (file extension: .sol) - a programming language for Ethereum platform influenced by C++, Javascript, Python etc.  
* **Hardhat vs Truffle,** smart contract development frameworks for Ethereum. Hardhat is easy for debug, Truffle has a nich Ganache GUI for account balance 
